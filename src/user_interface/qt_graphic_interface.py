...
class QtUiForm(object):
    def setup_ui(self, Form):
        ...
        self.path_edit.setGeometry(QtCore.QRect(80, 30, 281, 20))
        ...
        self.start_edit = QtWidgets.QLineEdit(Form)
        self.start_edit.setGeometry(QtCore.QRect(80, 70, 41, 20))
        self.start_edit.setObjectName("start_edit")
        self.start_edit.setText('1')
        self.step_edit = QtWidgets.QLineEdit(Form)
        self.step_edit.setGeometry(QtCore.QRect(320, 70, 41, 20))
        self.step_edit.setObjectName("step_edit")
        self.step_edit.setText('1')
